...
def main():
    ...
    if not ss.investments_data_pf1.equals(investments_details_v2)  or not ss.investments_amount_pf1.equals(investments_edited_df):
    ...
    if 'revenue_return_pf1' not in ss:
